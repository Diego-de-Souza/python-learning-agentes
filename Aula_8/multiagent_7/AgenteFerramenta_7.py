...
class AgenteFerramenta_7:
    ...
    def _extrair_tool(self, texto):
        ...
        try:
            ...
            if isinstance(obj, dict) and "tool" in obj:
                if obj["tool"] in ["calculadora", "conversor", "pesquisar", "dicionario", "receita", "adicionar_receita"]:
                    json_str = texto[:idx]
                    return obj, json_str
    ...
    def adicionar_receita(self, nome: str, porcoes: int, ingredientes_str: str, passos_str: str) -> str:
        ...
        try:
            ...
            # Escreve a nova receita no ficheiro receitas.json
